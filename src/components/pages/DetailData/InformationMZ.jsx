    ...
    <div>
        ...
        <div className='grid grid-cols-2 mt-5'>
            <div className='text-xs text-grey-light mb-3'>
                ...
                <div className='flex flex-col gap-y-1 mt-3'>
                    <p>NIK</p>
                    <p className='text-basic-grey text-sm font-medium'>MZ Mayang</p>
                </div>
            </div>
            <div className='flex text-xs gap-x-6 text-grey-light'>
                ...
                <div>
                    <div className='flex flex-col gap-y-1'>
                        <p>Tahun masuk TN</p>
                        <p className='text-basic-grey text-sm font-medium'>2017</p>
                    </div>
                    <div className='flex flex-col gap-y-1 mt-3'>
                        <p>Suluk ke-</p>
                        <p className='text-basic-grey text-sm font-medium'>3</p>
                    </div>
                    <div className='flex flex-col gap-y-1 mt-3'>
                        <p>Kaji</p>
                        <p className='text-basic-grey text-sm font-medium'>Wukuf</p>
                    </div>
                </div>
            </div>
        </div>
